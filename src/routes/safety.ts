...
const routes: FastifyPluginAsync = async app => {
  app.post("/documents", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.SAFETY_MANAGER) }, async (req, reply) => {
  ...
  app.post("/documents/:id/publish", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.SAFETY_MANAGER) }, async (req, reply) => {
    const { id } = z.object({ id: z.string().uuid() }).parse(req.params);
  ...
  app.post("/hazards", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.FOREMAN, Role.SAFETY_MANAGER) }, async (req, reply) => {
  ...
  app.patch("/hazards/:id/status", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.FOREMAN, Role.SAFETY_MANAGER) }, async req => {
  ...
  app.post("/hazards/:id/controls", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.FOREMAN, Role.SAFETY_MANAGER) }, async (req, reply) => {
  ...
  app.patch("/controls/:id/verify", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.SAFETY_MANAGER) }, async req => {
  ...
  app.post("/inspections", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.FOREMAN, Role.SAFETY_MANAGER) }, async (req, reply) => {
  ...
  app.patch("/inspections/:id/complete", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.SAFETY_MANAGER) }, async req => {
  ...
  app.post("/permits", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.FOREMAN, Role.SAFETY_MANAGER) }, async (req, reply) => {
  ...
  app.patch("/permits/:id/status", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.SAFETY_MANAGER) }, async req => {
  ...
  app.post("/actions", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.FOREMAN, Role.SAFETY_MANAGER) }, async (req, reply) => {
  ...
  app.patch("/actions/:id", { preHandler: allow(Role.OWNER, Role.ADMIN, Role.PROJECT_MANAGER, Role.SUPERVISOR, Role.SITE_SUPERVISOR, Role.SITE_ENGINEER, Role.FOREMAN, Role.SAFETY_MANAGER) }, async req => {

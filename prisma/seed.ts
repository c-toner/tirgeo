...
const organisation = await prisma.organisation.upsert({ where: { abn: "00000000000" }, update: {}, create: { name: "TirGeo Demo Civil", abn: "00000000000" } });
...
console.log({ organisationId: organisation.id, email: "admin@tirgeo.local", password: "ChangeMe123!" });

...
export const TIMESHEET_APPROVERS: Role[] = ["OWNER", "ADMIN", "PROJECT_MANAGER", "SUPERVISOR", "FOREMAN"];
export const HSEQ_EDITORS: Role[] = ["OWNER", "ADMIN", "PROJECT_MANAGER", "SUPERVISOR", "FOREMAN", "SAFETY_MANAGER"];
export const HSEQ_VERIFIERS: Role[] = ["OWNER", "ADMIN", "PROJECT_MANAGER", "SUPERVISOR", "SAFETY_MANAGER"];
export const DOCUMENT_AUTHORS: Role[] = ["OWNER", "ADMIN", "PROJECT_MANAGER", "SUPERVISOR", "SAFETY_MANAGER"];

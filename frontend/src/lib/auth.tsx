...
export const PROJECT_LEADERS: Role[] = ["OWNER", "ADMIN", "PROJECT_MANAGER"];
export const TIMESHEET_APPROVERS: Role[] = ["OWNER", "ADMIN", "PROJECT_MANAGER", "SUPERVISOR", "SITE_SUPERVISOR", "FOREMAN"];
export const HSEQ_EDITORS: Role[] = ["OWNER", "ADMIN", "PROJECT_MANAGER", "SUPERVISOR", "SITE_SUPERVISOR", "SITE_ENGINEER", "FOREMAN", "SAFETY_MANAGER"];
export const HSEQ_VERIFIERS: Role[] = ["OWNER", "ADMIN", "PROJECT_MANAGER", "SUPERVISOR", "SITE_SUPERVISOR", "SITE_ENGINEER", "SAFETY_MANAGER"];
export const DOCUMENT_AUTHORS: Role[] = ["OWNER", "ADMIN", "PROJECT_MANAGER", "SUPERVISOR", "SITE_SUPERVISOR", "SITE_ENGINEER", "SAFETY_MANAGER"];
export const DOCUMENT_APPROVERS: Role[] = ["OWNER", "ADMIN", "SAFETY_MANAGER"];
export const PAYROLL_MANAGERS: Role[] = ["OWNER", "ADMIN", "PAYROLL"];
export const PLANT_CLEARERS: Role[] = ["OWNER", "ADMIN", "PROJECT_MANAGER", "SAFETY_MANAGER"];
